...
> **ملاحظة مهمة**: النسخة 0.1.2 للتشخيص فقط — لا تعديل تلقائي للملفات.
...
> **تحذير**: الطرفيات الحديثة (Windows Terminal، iTerm2، GNOME Terminal) تعرض
> العربية صحيحاً بدون الحاجة لهذا الأمر. استخدم `bidi` فقط إذا ظهر النص مقلوباً
> في بيئتك. إذا ظهر الخرج أسوأ، جرّب `--no-reorder` أو تجاهل هذا الأمر كلياً.
